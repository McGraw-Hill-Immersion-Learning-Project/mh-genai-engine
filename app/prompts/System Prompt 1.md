...
(Covers definitions, scope, methods, and systems of economics) (OpenStax)
...
•	Economics as a framework for understanding societal issues (OpenStax)
...
•	Policy tools: fiscal policy and monetary policy (OpenStax)
...
•	Circular flow: interaction between households and firms (OpenStax)
________________________________________
• Common misconceptions of the entire chapter
•	Economics is only about money or finance (it is about decision-making under scarcity) (OpenStax)
•	Markets always require perfect information to function (decisions occur under imperfect information) (OpenStax)
•	Microeconomics and macroeconomics are independent (they are interrelated perspectives) (OpenStax)
...
2.	Explain three reasons why division of labor increases productivity. (OpenStax)
3.	Differentiate between microeconomics and macroeconomics. (OpenStax)
4.	Identify the main goals of macroeconomics. (OpenStax)
5.	Describe the circular flow of economic activity.
6.	Compare market, command, and traditional economic systems. (OpenStax)
________________________________________
• Activity Ideas
...
________________________________________
• Citations
•	OpenStax, Principles of Economics 3e, Chapter 1 Introduction (OpenStax)
•	OpenStax, Principles of Economics 3e, Key Concepts and Summary (OpenStax)
•	OpenStax, Principles of Economics 3e, Key Terms (OpenStax)
•	OpenStax, Principles of Microeconomics 3e, Review Questions (OpenStax)
...
2.	1.1 What Is Economics, and Why Is It Important?
o	The Problem of Scarcity
o	The Division of and Specialization of Labor
o	Why Study Economics?
3.	1.2 Microeconomics and Macroeconomics
o	Microeconomics: The Focus on Individual Actors
o	Macroeconomics: The Focus on the Economy as a Whole
4.	1.3 How Economists Use Theories and Models to Understand Economic Issues
o	The Role of Economic Models (The Circular Flow Diagram)
5.	1.4 How Economies Can Be Organized: An Overview of Economic Systems
o	Traditional, Command, and Market Economies
o	The Role of Globalization
________________________________________
...
________________________________________
Citations
•	General Outline & Concepts: Greenlaw, S. A., Shapiro, D., & MacDonald, D. (2022). Principles of Economics 3e. OpenStax. Section 1.1–1.4. https://openstax.org/books/principles-economics-3e/pages/1-introduction
...
________________________________________
CHAPTER 1: WELCOME TO ECONOMICS Lecture Scaffold — 3rd Year University Level
________________________________________
GENERAL OUTLINE
Chapter 1 introduces the foundational framework of economics as a discipline. It is organized into four subsections:
1.1 What Is Economics, and Why Is It Important? 1.2 Microeconomics and Macroeconomics 1.3 How Economists Use Theories and Models to Understand Economic Issues 1.4 How Economies Can Be Organized: An Overview of Economic Systems
________________________________________
CORE CONCEPTS BY SUBSECTION
1.1 — What Is Economics, and Why Is It Important?
