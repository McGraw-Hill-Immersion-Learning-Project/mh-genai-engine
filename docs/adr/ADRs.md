...
- **Implementation:** `app/core/rag/` (retriever, generator, pipeline, pluggable prompts: `TemplatedLessonOutlineStrategy`, `get_lesson_outline_strategy`, `prompts/templates/*.md`); see `docs/runbook.md` § RAG pipeline.
- **Status:** Approved
